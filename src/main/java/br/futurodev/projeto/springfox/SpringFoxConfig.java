package br.futurodev.projeto.springfox;
...
public class SpringFoxConfig extends WebMvcConfigurationSupport {
    ...
    public Docket apiDocket(){
        return new Docket(DocumentationType.SWAGGER_2) //informa qual o tipo de documentação se vai usar
                ...
                .apiInfo(metaData())
                .tags(new Tag("Produto", "Gerencia Produtos"),
                        new Tag("Categoria", "Gerencia Categorias"));
    }

    private ApiInfo metaData(){
        return new ApiInfoBuilder()
                .title("LAB Supermarket")
                .description("API Rest do LabShoppingList")
                .version("1.0.0")
